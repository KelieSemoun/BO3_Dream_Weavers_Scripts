...
#using scripts\zm\kelie_spike_traps;
...
#precache( "model", "c_t7_zm_dlchd_shangrila_napalm_mini_fb");
#precache( "model", "c_t7_zm_dlchd_shangrila_vietcong_mini_head");
#precache( "model", "c_t7_zm_dlchd_shangrila_vietcong_mini_body");
#precache( "model", "c_t7_zm_dlchd_shangrila_nva_mini_head");
#precache( "model", "c_t7_zm_dlchd_shangrila_nva_mini_head2");
#precache( "model", "c_t7_zm_dlchd_shangrila_nva_mini_body");
#precache( "model", "c_t7_zm_dlchd_shangrila_fem_mini_head");
#precache( "model", "c_t7_zm_dlchd_shangrila_fem_mini_body");
#precache( "model", "c_t7_zm_dlchd_shangrila_fem_mini_body2");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_blegsoff2");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_llegoff2");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_loclean2");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_rarmoff2");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_rlegoff2");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_upclean2");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_larmoff2");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_blegsoff");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_llegoff");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_loclean");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_rarmoff");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_rlegoff");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_upclean");
#precache( "model", "c_t7_zm_dlchd_shangrila_mini_fem_g_larmoff");
...
#precache( "model", "c_t7_zm_dlchd_shangrila_vietcong_mini_g_blegsoff");
#precache( "model", "c_t7_zm_dlchd_shangrila_vietcong_mini_g_llegoff");
#precache( "model", "c_t7_zm_dlchd_shangrila_vietcong_mini_g_loclean");
#precache( "model", "c_t7_zm_dlchd_shangrila_vietcong_mini_g_rarmoff");
#precache( "model", "c_t7_zm_dlchd_shangrila_vietcong_mini_g_rlegoff");
#precache( "model", "c_t7_zm_dlchd_shangrila_vietcong_mini_g_upclean"); 
#precache( "model", "c_t7_zm_dlchd_shangrila_vietcong_mini_g_larmoff");
...
function __init__()
{
	...
	level.trigger_dancing_shrink = GetEnt("trig_shrink_dancing_zombie", "targetname");
	add_shrinkable_object(level.trigger_dancing_shrink);
...
function __main__()
{
	...
	level thread temple_shrink_ray_model_mapping_func();
...
Desc : Work in progress. Added a "FIRE_MODE_SHRINK" which is a macro described in the .gsh file.
/////////////////////////////////////////
*/
...
function function_37ce705e()
{
	...
	for(;;)
	{
		...
		if(currentweapon == level.w_shrink_ray || currentweapon == level.w_shrink_ray_upgraded || currentweapon == level.w_shrink_ray_turret)
		{
			self thread function_fe7a4182(currentweapon == level.w_shrink_ray_upgraded, FIRE_MODE_SHRINK);
		}
	}
}
...
Desc : Work in progress. This function checks each shrinkable objects what entity it is. Originally, this just handles zombies but this also handles the dancing zombies trigger. And after it gets implemented, it will also handle the unshrinking of zombies and shrinking of spike traps.
/////////////////////////////////////////
*/

function function_fe7a4182(upgraded, fire_mode)
{
	...
	{
		if(isai(zombies[i]) && fire_mode == FIRE_MODE_SHRINK)
		{
			zombies[i] thread shrink_zombie(upgraded, self);
			continue;
		}
		else if(zombies[i] == level.trigger_dancing_shrink && fire_mode == FIRE_MODE_SHRINK)
		{
			remove_shrinkable_object(level.trigger_dancing_shrink);
			thread resolve_trigger();
			continue;
		}
		else //SPIKE TRAPS -- HORRIBLE CODING
			kelie_spike_traps::handle_spike_trap(zombies[i], fire_mode);
...
function unshrink_zombie(meleedamage = self.meleedamage)
{
	attachedmodels = [];
	hatmodel = self.hatmodel;
...
function temple_shrink_ray_model_mapping_func()
{
	...
	level.shrink_models["shang_head"] = "c_t7_zm_dlchd_shangrila_vietcong_mini_head";
	level.shrink_models["shang_body"] = "c_t7_zm_dlchd_shangrila_vietcong_mini_body";
	level.shrink_models["shang_head2"] = "c_t7_zm_dlchd_shangrila_nva_mini_head";
	level.shrink_models["shang_head3"] = "c_t7_zm_dlchd_shangrila_nva_mini_head2";
	level.shrink_models["shang_body2"] = "c_t7_zm_dlchd_shangrila_nva_mini_body";
	level.shrink_models["shang_head4"] = "c_t7_zm_dlchd_shangrila_fem_mini_head";
	level.shrink_models["shang_body3"] = "c_t7_zm_dlchd_shangrila_fem_mini_body";
	level.shrink_models["shang_body4"] = "c_t7_zm_dlchd_shangrila_fem_mini_body2";
	level.shrink_models["shang_blegsoff3"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_blegsoff2";
	level.shrink_models["shang_llegoff3"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_llegoff2";
	level.shrink_models["shang_loclean3"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_loclean2";
	level.shrink_models["shang_rarmoff3"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_rarmoff2";
	level.shrink_models["shang_rlegoff3"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_rlegoff2";
	level.shrink_models["shang_up_clean4"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_upclean2";
	level.shrink_models["shang_larmoff4"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_larmoff2";
	level.shrink_models["shang_blegsoff3"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_blegsoff";
	level.shrink_models["shang_llegoff3"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_llegoff";
	level.shrink_models["shang_loclean3"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_loclean";
	level.shrink_models["shang_rarmoff3"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_rarmoff";
	level.shrink_models["shang_rlegoff3"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_rlegoff";
	level.shrink_models["shang_up_clean3"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_upclean";
	level.shrink_models["shang_larmoff3"] = "c_t7_zm_dlchd_shangrila_mini_fem_g_larmoff";
	level.shrink_models["shang_blegsoff2"] = "c_t7_zm_dlchd_shangrila_nva_mini_g_blegsoff";
	level.shrink_models["shang_llegoff2"] = "c_t7_zm_dlchd_shangrila_nva_mini_g_llegoff";
	level.shrink_models["shang_loclean2"] = "c_t7_zm_dlchd_shangrila_nva_mini_g_loclean";
	level.shrink_models["shang_rarmoff2"] = "c_t7_zm_dlchd_shangrila_nva_mini_g_rarmoff";
	level.shrink_models["shang_rlegoff2"] = "c_t7_zm_dlchd_shangrila_nva_mini_g_rlegoff";
	level.shrink_models["shang_up_clean2"] = "c_t7_zm_dlchd_shangrila_nva_mini_g_upclean";
	level.shrink_models["shang_larmoff2"] = "c_t7_zm_dlchd_shangrila_nva_mini_g_larmoff";
	level.shrink_models["shang_blegsoff"] = "c_t7_zm_dlchd_shangrila_vietcong_mini_g_blegsoff";
	level.shrink_models["shang_llegoff"] = "c_t7_zm_dlchd_shangrila_vietcong_mini_g_llegoff";
	level.shrink_models["shang_loclean"] = "c_t7_zm_dlchd_shangrila_vietcong_mini_g_loclean";
	level.shrink_models["shang_rarmoff"] = "c_t7_zm_dlchd_shangrila_vietcong_mini_g_rarmoff";
	level.shrink_models["shang_rlegoff"] = "c_t7_zm_dlchd_shangrila_vietcong_mini_g_rlegoff";
	level.shrink_models["shang_up_clean"] = "c_t7_zm_dlchd_shangrila_vietcong_mini_g_upclean";
	level.shrink_models["shang_larmoff"] = "c_t7_zm_dlchd_shangrila_vietcong_mini_g_larmoff";
}
...
Desc : The following function is executed when the dancing zombies trigger is shrinked by the weapon. Deletes it, shrinks the dancing napalm zombie, deletes the invisible barrier and creates a radius hitbox to kick it when close to it.
/////////////////////////////////////////
*/

function resolve_trigger()
{
	dancing_zombie = GetEnt(level.trigger_dancing_shrink.target, "targetname");
	door_trigger = GetEnt(level.trigger_dancing_shrink.target + "_door", "targetname");
	//handle_door
	if(isdefined(door_trigger.script_flag) && door_trigger.script_flag!="")
	{
		flag::init(door_trigger.script_flag);
	}
	if(isdefined(door_trigger.script_flag))
	{
		level flag::set(door_trigger.script_flag);
	}
	door_clip = GetEnt(door_trigger.target, "targetname");
	door_clip delete();
	door_trigger delete();

	//handle_dancing_zombie

	//shrink_permanently
	dancing_zombie SetModel(level.shrink_models["c_t7_zm_dlchd_shangrila_napalm_body"]);

	//hitbox
	dancing_zombie.hitbox_mini = spawn("trigger_radius", dancing_zombie.origin, 0, 30, 24);
	dancing_zombie.hitbox_mini sethintstring("");
	dancing_zombie.hitbox_mini setcursorhint("HINT_NOICON");
	dancing_zombie.hitbox_mini enablelinkto();
	dancing_zombie.hitbox_mini linkto(dancing_zombie);
	player_didnt_hit_zombie = true;

	while(player_didnt_hit_zombie)
	{
		dancing_zombie.hitbox_mini waittill("trigger", who);
		if(!isplayer(who))
		{
			continue;
		}
		player_didnt_hit_zombie = false;
		dancing_zombie.hitbox_mini Delete();
	}

	dancing_zombie StopAnimScripted();
	dancing_zombie MoveTo((3258 , 970 , 930), 1);
	who thread zm_audio::create_and_play_dialog("kill", "shrunken");
	wait 1;
	dancing_zombie Delete();
}